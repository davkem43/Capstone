...
<div class="find-search">
    <input type = "text" class="search-box" size="40" id="peer-search" name="q" placeholder="Enter a name or group" value="" maxlength="40" aria-label="Search for a peer by name">
    <button class="search-box" id="peer" form="">Search</button>
    <button class="search-box" id="pledge" form="">Pledge Now</button>
